...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BY_ID_AND_USER_ID, query = "SELECT m FROM Meal m WHERE m.id=:id AND m.user.id=:user_id"),
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String ALL_BETWEEN_HALF_OPEN = "Mela.getAllBetweenHalfOpen";
